        ...
        <div className="shell">
          <div className="stack" style={{ '--stack-gap': '2.5rem' } as React.CSSProperties}>
            ...
            <section className="prose">
              ...
              <p>Ordinary files and photos in the private Library are not sent to an AI service by default. If the feature is available, you can choose one saved Library photo or attach one new JPEG or PNG and give permission for Rolo to inspect it for one message. A new attachment is first saved as a private Library photo for that home. Homesrolo verifies access to that exact home and photo, creates a fresh JPEG copy with embedded metadata removed, and sends only that copy and your message to OpenAI. The private original is not sent, the permission does not apply to other photos or later messages, and photo checkups are excluded from this feature.</p>
