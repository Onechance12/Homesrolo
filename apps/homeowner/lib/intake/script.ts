 ...
 * systems inventory maps to the exact-home intake contract; it is sent only
 * after the private home shell exists.
 */
...
export interface IntakeDraft {
  ...
  /** Homeowner-recalled facts for the exact-home intake command. */
  readonly profile: {
