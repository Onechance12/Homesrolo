 ...
 *
 * Exactly one named HttpOnly cookie is consulted, and its value is treated as
 ...
 * infrastructure, not by anything in this repository yet. The name and bounds
 * below are this adapter's documented assumption for that lane.
 */
