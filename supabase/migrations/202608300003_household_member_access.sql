...
-- Adult household collaborators use the same Home Record and may organize the
-- photos they add. Updates and administrative household controls remain
-- controller-only; viewers remain read-limited.
...
revoke all on function public.homesrolo_read_home_record(text, text, text, integer)
  from public, anon, authenticated;
grant execute on function public.homesrolo_read_home_record(text, text, text, integer)
  to service_role;
